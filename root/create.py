...
contraindication1 = Contraindication(name='Allergy', additional_info='The only contraindication applicable to all vaccines is a history of a severe allergic reaction after a prior dose of vaccine or to a vaccine constituent. Precautions are not contraindications, but are events or conditions to be considered in determining if the benefits of the vaccine outweigh the risks. Precautions stated in product labelling can sometimes be inappropriately used as absolute contraindications, resulting in missed opportunities to vaccinate.')
contraindication2 = Contraindication(name='Pregnancy', additional_info='Before a diagnosis of some conditions, your doctor may consider whether getting pregnant is safe for you or on the contrary it would aggravate the symptoms associated. In some cases, a pregnancy can turn out to be a life-threatening event for the woman and the baby, especially if you suffer from any of the following conditions:')
contraindication3 = Contraindication(name='Drug Abuse', additional_info='For more information you need contact to you doctor. Thank you.')
